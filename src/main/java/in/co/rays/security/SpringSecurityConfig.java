...
import in.co.rays.security.JWT.JwtEntryPoint;
import in.co.rays.security.JWT.JwtFilter;
...
public class SpringSecurityConfig extends WebSecurityConfigurerAdapter{
    ...
    public void configure(AuthenticationManagerBuilder auth) throws Exception{
        System.out.println("INSIDE Spring security configure"+dataSource);
    	try{
        auth
                .jdbcAuthentication()
